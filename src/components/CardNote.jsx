...
const CardNote = ({ note }) => {
  ...
  return (
    <Link
      to={`/view/${note.id}`}
      className="w-[350px] h-fit flex flex-col items-end shadow-[9px_5px_0px_0px_rgba(0,_0,_0,_0.8)] rounded-lg hover:scale-105 transition duration-300 overflow-hidden"
    >
      <div
